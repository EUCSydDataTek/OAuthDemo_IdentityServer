...
namespace Pluralsight.Client.M3
{
    public sealed partial class MainPage : Page
    {
        ...
        private async void Authorize_Click(object sender, RoutedEventArgs e)
        {
            ...
            var url = "https://localhost:5000/connect/authorize" +
        ...
        private async void Token_Click(object sender, RoutedEventArgs e)
        {
            ...
            var tokenClient = new TokenClient("https://localhost:5000/connect/token", "native_client");
        ...
        private async void Api_Click(object sender, RoutedEventArgs e)
        {
            ...
            var response = await httpClient.GetAsync("https://localhost:5002/api/rewards");
